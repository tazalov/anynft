(() => {
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: r } = t.navigation,
          a = s.target;
        if (t.params.navigation.hideOnClick && !x(a).is(r) && !x(a).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function ge(e) {
    ...
    function d() {
      ...
      p ? (l(), s.off("scroll", d, h)) : r || ((r = !0), s.on("scroll", d, h));
    }
    i("beforeInit", () => {
    ...
    ve(),
      document.querySelector(".swiper") &&
        new ce(".swiper", {
          ...
          keyboard: { enabled: !0, onlyInViewpot: !0 },
          breakpoints: {
  ...
  let be = document.getElementsByClassName("img-nft")[0],
    ye = be.getAttribute("data-nft"),
    Ce = Math.round(8 * Math.random());
  if (ye.length > 0)
    if ("en" === ye) {
      let Ae = [
        "img/nft/en/Beagle.jpg",
        "img/nft/en/Border-Collie.jpg",
        "img/nft/en/Boston-terrier.jpg",
        "img/nft/en/Dachshund.jpg",
        "img/nft/en/Husky.jpg",
        "img/nft/en/Retriever.jpg",
        "img/nft/en/Shiba-inu.jpg",
        "img/nft/en/Spaniel.jpg",
        "img/nft/en/Welsh-Corgi.jpg",
      ];
      be.src = Ae[Ce];
      var Se = document
          .getElementsByClassName("img-nft")[0]
          .getAttribute("src"),
        Ee = document.getElementsByClassName("dog-name")[0],
        Te = /([^/]+).{4}$/.exec(Se);
      Ee.innerHTML = Te[1];
    } else {
      let Oe = [
        "img/nft/ru/Бигль.jpg",
        "img/nft/ru/Бордер-колли.jpg",
        "img/nft/ru/Бостон-терьер.jpg",
        "img/nft/ru/Такса.jpg",
        "img/nft/ru/Хаски.jpg",
        "img/nft/ru/Ретривер.jpg",
        "img/nft/ru/Шиба-ину.jpg",
        "img/nft/ru/Спаниель.jpg",
        "img/nft/ru/Корги.jpg",
      ];
      be.src = Oe[Ce];
      (Se = document.getElementsByClassName("img-nft")[0].getAttribute("src")),
        (Ee = document.getElementsByClassName("dog-name")[0]),
        (Te = /([^/]+).{4}$/.exec(Se));
      Ee.innerHTML = Te[1];
    }
  let xe = document.querySelectorAll("._anim-items");
  if (xe.length > 0) {
    function _e() {
      for (let e = 0; e < xe.length; e++) {
        ...
        s > window.innerHeight &&
          ...
          scrollY > i - r && scrollY < i + s
            ? t.classList.add("_active")
            : t.classList.contains("_anim-norepeat") ||
  ...
  let Le = document.getElementsByClassName("stats__text");
  for (let Ie = 0; Ie < Le.length; Ie++)
    var ke = Le[0], $e = Le[1], Me = Le[2], Pe = Le[3];
  fetch("https://api.opensea.io/api/v1/collection/any-nft/stats")
    .then((e) => e.json())
    .then((e) => {
      (ke.innerHTML = e.stats.total_supply),
        ($e.innerHTML = e.stats.num_owners),
        (Me.innerHTML = e.stats.floor_price.toFixed(2)),
        (Pe.innerHTML = e.stats.total_volume.toFixed(3));
    })
